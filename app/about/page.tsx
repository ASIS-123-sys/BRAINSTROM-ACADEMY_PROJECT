  ...
  return (
    <div className={`min-h-screen bg-[#0F172A] text-[#F8FAFC] overflow-x-hidden ${poppins.className}`}>
      ...
      <section className="pt-24 pb-16 px-6 flex flex-col items-center justify-center text-center max-w-6xl mx-auto">
        ...
        <p
          ref={addToRefs}
          className="opacity-0 translate-y-10 transition-all duration-700 delay-200 ease-out text-lg text-[#94A3B8] max-w-2xl mx-auto mb-16"
        >
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={addToRefs} className="opacity-0 translate-y-10 transition-all duration-700 ease-out space-y-6">
            ...
            <p className="text-[#94A3B8] leading-relaxed text-md">
          ...
          <div ref={addToRefs} className="opacity-0 translate-y-10 transition-all duration-700 delay-100 ease-out relative group">
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-[#06B6D4] to-[#3B82F6] opacity-35 blur-xl group-hover:opacity-60 transition duration-500"></div>
            <img
              src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=600"
              alt="Brainstorm Academy Learning Environment"
              className="relative w-full h-[350px] object-cover rounded-2xl border border-white/10"
            />
          </div>
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto space-y-12">
        <h2 ref={addToRefs} className="opacity-0 translate-y-10 transition-all duration-700 ease-out text-3xl md:text-4xl font-bold text-center">
          What We Stand For
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {values.map((val, idx) => (
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold text-[#F8FAFC] mb-2">{val.title}</h3>
                <p className="text-[#94A3B8] leading-relaxed">{val.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto space-y-12">
        ...
        <div
          ...
          className="opacity-0 translate-y-10 transition-all duration-700 ease-out p-8 md:p-12 border-l-4 border-l-[#F59E0B] flex flex-col md:flex-row gap-8 items-center"
        >
          {/* Avatar circle */}
          <div className="w-24 h-24 rounded-full bg-[#06B6D4]/10 border-2 border-[#06B6D4] flex items-center justify-center text-3xl font-extrabold text-[#06B6D4] shrink-0">
            AK
          </div>
          
          <div className="space-y-4 text-center md:text-left flex-grow">
            <div>
              <h3 className="text-2xl font-bold text-[#F8FAFC]">Mr. Asis Kumar</h3>
              <p className="text-[#06B6D4] font-medium text-sm">Founder & Director, Brainstorm Academy</p>
            </div>
            
            <p className="text-[#94A3B8] italic leading-relaxed text-md">
            ...
            {/* ISO Badge */}
            <div className="pt-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/5 text-[#94A3B8] border border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason, idx) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-[#F8FAFC] mb-2">{reason.title}</h3>
