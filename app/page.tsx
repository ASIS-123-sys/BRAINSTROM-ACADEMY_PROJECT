        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              >
                Empowering Every Student to Achieve <span className="text-[#2dbcfe]">Excellence</span>
              </h1>
            ...
            <div className="lg:col-span-5 flex justify-center w-full">
              <div 
                ...
                style={{ background: "linear-gradient(135deg, #D8E8FB 0%, #C5DDF5 100%)" }}
              ></div>
            </div>
      ...
      <section className="bg-[#DCE9F9] py-4 flex items-center overflow-hidden z-20 relative border-t border-b border-[#B8D4F0]">
        ...
        <div className="flex-1 ticker-container py-1">
          <div className="ticker">
            {/* Set 1 */}
            {notices.map((n, i) => (
              <span key={i} className="flex items-center gap-4 text-[#111c2d] font-semibold text-xs sm:text-sm">
                <span>{n}</span>
            ...
            {/* Set 2 */}
            {notices.map((n, i) => (
              <span key={`dup-${i}`} className="flex items-center gap-4 text-[#111c2d] font-semibold text-xs sm:text-sm">
                <span>{n}</span>
                <span className="w-2 h-2 rounded-full bg-[#2dbcfe]"></span>
              </span>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#003358] leading-tight">Computer Courses 💻</h3>
                  <p className="text-xs text-[#42576E] font-medium">Vocational Tech</p>
                </div>
              </div>
              ...
              <div className="border-t border-[#7FB3E8] pt-6 flex-1 flex flex-col justify-between">
                <div>
                  <h4 className="text-xs font-bold text-[#5A7186] uppercase tracking-widest mb-3">Facilities:</h4>
                  <ul className="space-y-2.5 mb-8">
                    {["Seminars Exam", "Syllabus Material", "KIT Bag", "ID Card", "AC Class Room"].map((fac) => (
                      <li key={fac} className="flex items-center gap-2.5 text-sm text-[#1E3A52] font-medium">
                        <svg className="w-4 h-4 text-[#2dbcfe] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#003358] leading-tight">12th Grade 📚</h3>
                  <p className="text-xs text-[#42576E] font-medium">Higher Secondary</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#003358] leading-tight">5th to 10th Grade ✏️</h3>
                  <p className="text-xs text-[#42576E] font-medium">Secondary Foundation</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {performers.map((student) => (
              ...
              >
                ...
                <h4 className="font-bold text-[#003358] text-base leading-tight mb-1">{student.name}</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 w-full max-w-md mx-auto lg:max-w-none">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-[#003358] mb-2">Director's Desk</h3>
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <h5 className="font-bold text-[#003358] text-sm">Mr. Asis Kumar</h5>
                    <p className="text-xs text-[#111c2d]/80 font-medium">Founder and Director</p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 flex flex-col gap-6">
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <a href="tel:+919933825835" className="text-[#2dbcfe] hover:underline font-semibold text-sm sm:text-base">
                      +91 99338 25835
                    </a>
                    <a href="tel:+912008548156" className="text-[#2dbcfe] hover:underline font-semibold text-sm sm:text-base">
                      +91 20085 48156
                    </a>
                  </div>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1">
                    <a href="mailto:avisdasw4@gmail.com" className="text-[#2dbcfe] hover:underline font-semibold text-sm sm:text-base break-all">
                      avisdasw4@gmail.com
                    </a>
                    <a href="mailto:brainstormdplusacademy@gmail.com" className="text-[#2dbcfe] hover:underline font-semibold text-sm sm:text-base break-all">
