...
export default function ContactPage() {
  ...
  return (
    <div className={`min-h-screen bg-[#F7FAFD] text-[#42576E] overflow-x-hidden pb-24 ${poppins.className}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="space-y-6 flex flex-col justify-between">
            ...
            >
              ...
              <div className="space-y-1">
                <h3 className="text-lg font-bold text-[#003358]">Phone Numbers</h3>
                <p className="text-xs text-[#42576E] font-medium">Call us directly during office hours</p>
                <div className="flex flex-col gap-1 pt-2">
                  <a href="tel:+919933825835" className="text-[#00658d] font-semibold hover:underline w-fit">
                    +91 99338 25835
                  </a>
                  <a href="tel:+912008548156" className="text-[#00658d] font-semibold hover:underline w-fit">
                    +91 20085 48156
                  </a>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-1">
                <h3 className="text-lg font-bold text-[#003358]">Email Addresses</h3>
                <p className="text-xs text-[#42576E] font-medium">Send us your queries anytime</p>
                <div className="flex flex-col gap-1 pt-2">
                  <a href="mailto:avisdasw4@gmail.com" className="text-[#00658d] font-semibold hover:underline w-fit break-all">
                    avisdasw4@gmail.com
                  </a>
                  <a href="mailto:brainstormdplusacademy@gmail.com" className="text-[#00658d] font-semibold hover:underline w-fit break-all">
            ...
            >
              ...
              <div className="space-y-1">
                <h3 className="text-lg font-bold text-[#003358]">Institute Location</h3>
                <p className="text-xs text-[#42576E] font-medium">Come visit us</p>
          ...
          >
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#003358]">Brainstorm Academy</h3>
              <p className="text-sm text-[#42576E] mt-1">Near Radio Station, Berhampur, Odisha, India</p>
      ...
      <section className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              <span className="text-xs uppercase tracking-wider text-[#00658d] font-semibold mb-2">{item.day}</span>
              <span className="text-lg font-bold text-[#003358]">{item.hours}</span>
            </div>
          ))}
        </div>
      </section>
